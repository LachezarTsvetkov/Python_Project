...
class Agent():
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size=100000, eps_end=0.01, eps_dec=5e-4):
        ...
        self.Q_eval = DeepQNetwork(self.lr, self.n_actions, input_dims=input_dims, fc1_dims=256, fc2_dims=256)
    ...
    def learn(self):
        ...
        q_eval = self.Q_eval.forward(state_batch)[batch_index, actions_batch]
        ...
        self.epsilon = self.epsilon - self.eps_dec if self.epsilon > self.eps_dec \
                else self.eps_min
